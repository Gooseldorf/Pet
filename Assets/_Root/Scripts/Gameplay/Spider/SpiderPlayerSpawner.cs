...
namespace Pet.Gameplay
{
    public class SpiderPlayerSpawner
    {
        ...
        public SpiderPlayerSpawner(SpiderConfig spiderConfig, PlayerSpawnPoint spiderSpawnPoint, IPlayerInputStreams inputStreams, Camera movementCamera)
        {
        ...
        {
            SpiderPlayerController instance = Object.Instantiate(spiderConfig.Prefab, spiderSpawnPoint.transform.position, spiderSpawnPoint.transform.rotation);
